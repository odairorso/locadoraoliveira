...
export const ClienteSchema = z.object({
  ...
  estado: z.string().min(2, "Estado é obrigatório").max(2, "Estado deve ter 2 caracteres").optional(),
  cep: z.string().min(8, "CEP deve ter 8 dígitos").max(10, "CEP inválido").optional(),
