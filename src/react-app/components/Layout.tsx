              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="px-1.5 py-0.5 rounded text-[9px] font-black bg-amber-500/20 text-amber-400 border border-amber-500/40">v2.6.5</span>
                  </div>
            ...
            <div className="flex items-center px-6 mb-4">
              ...
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-[9px] font-black text-amber-400 bg-amber-500/15 px-1.5 py-0.5 rounded border border-amber-500/30">v2.6.5</span>
                </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <span className="text-[9px] font-black text-amber-400 bg-amber-500/10 px-1.5 py-0.5 rounded border border-amber-500/30 inline-block leading-none">v2.6.5</span>
              </div>
            </div>
          </div>
